    ...
    <>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.content}>
          ...
          <View style={styles.sectionCard}>
            <Text style={styles.sectionTitle}>Día segundo</Text>
            <Text style={styles.prayer}>
          ...
          <View style={styles.sectionCard}>
            <Text style={styles.sectionTitle}>Día tercero</Text>
            <Text style={styles.prayer}>
          ...
          <View style={styles.sectionCard}>
            <Text style={styles.sectionTitle}>Día cuarto</Text>
            <Text style={styles.prayer}>
          ...
          <View style={styles.sectionCard}>
            <Text style={styles.sectionTitle}>Día quinto</Text>
            <Text style={styles.prayer}>
          ...
          <View style={styles.sectionCard}>
            <Text style={styles.sectionTitle}>Día sexto</Text>
            <Text style={styles.prayer}>
          ...
          <View style={styles.sectionCard}>
            <Text style={styles.sectionTitle}>Día séptimo</Text>
            <Text style={styles.prayer}>
          ...
          <View style={styles.sectionCard}>
            <Text style={styles.sectionTitle}>Día octavo</Text>
            <Text style={styles.prayer}>
              Oh benignísimo Jesús, que en la hora de su muerte consolaste a tu glorioso padre, asistiendo juntamente con tu Madre su esposa a su última agonía, te suplicamos humildemente, por inter- cesión de San José, que nos concedas una muer- te semejante a la suya asistido de tu bondad, de tu Santísima Madre y del mismo glorioso Patriarca protector de los moribundos, pronunciando al morir vuestros santísimos nombres, Jesús, María y José.
            </Text>
          </View>

          <View style={styles.sectionCard}>
            <Text style={styles.sectionTitle}>Día noveno</Text>
            <Text style={styles.prayer}>
