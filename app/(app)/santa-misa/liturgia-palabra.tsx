    ...
    <>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.content}>
          ...
          <Text style={styles.texto}>Te alabamos, Señor.</Text>
          ...
          <Text style={styles.textoItalica}>El sacerdote, inclinado ante el altar, dice en voz baja:</Text>
          <Text style={styles.texto}>
            Purifica mi corazón y mis labios, Dios todopoderoso, para que anuncie dignamente tu Evangelio.
          </Text>
          <Text style={styles.textoItalica}>Después, en voz alta dice al pueblo:</Text>
          ...
          <Text style={styles.texto}>Gloria a Ti, Señor.</Text>
          <Text style={styles.textoItalica}>Una vez leído el Evangelio, el sacerdote dice:</Text>
          <Text style={styles.texto}>Palabra del Señor.</Text>
          <Text style={styles.texto}>Gloria a Ti, Señor Jesús.</Text>
          <Text style={styles.textoItalica}>El sacerdote besa el libro, diciendo en voz baja:</Text>
          ...
          <Text style={styles.textoItalica}>Si es festivo, todos rezarán el Credo:</Text>
          <Text style={styles.texto}>
            Creo en Dios, Padre Todopoderoso,{'\n'}
            Creador del cielo y de la tierra.{'\n'}
            Creo en Jesucristo, su único Hijo, Nuestro Señor,{'\n'}
            <Text style={styles.textoItalica}>(En las palabras que siguen, hasta María Virgen, todos se inclinan)</Text>{'\n'}
